      ...
      var barChartTC_Projeto = dc.barChart('#chartTC_Projeto_Client1');

      // Chart Bugs por projeto
      var barChartBugs_Projeto = dc.barChart('#chartBugs_Projeto_Client1');

      // Gráfico de barras com DRE por projeto
      var dreProjectChart = dc.barChart('#chartDRE_Project_Client1');

      // Gráfico para quantidade de casos de teste por release
      var barChartTC_Release = dc.barChart('#chartTC_Release_Client1');

      // Gráfico para quantidade de casos de teste por release
      var barChartBugs_Release = dc.barChart('#chartBugs_Release_Client1');

      // Gráfico de barras com DRE por release
      var dreReleaseChart = dc.barChart('#chartDRE_Release_Client1');

      // Gráfico de horas estimadas x reais por release
      var compositeHorasReleaseChart = dc.compositeChart('#chartHoras_Release_Client1');

      // Gráfico de Casos de teste x Bugs
      var scatterChart = dc.scatterPlot('#scatterChart_Client1');
